...
export function DistrictList({
  ...
  if (rows.length === 0) {
    return <EmptyState title="No districts match this view" hint="Try a different capability or region." />;
  }
  ...
  return (
    <div className="px-3 pb-4">
      {groups.map((g, index) => {
        ...
        return (
          <section key={g.verdict} className="mb-3">
            <header className="sticky top-0 z-10 -mx-3 border-y border-line bg-bg-sunken/95 backdrop-blur-sm">
              <button
                type="button"
